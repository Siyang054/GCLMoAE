...
parser.add_argument('--data', type=str, default='mHSC-GM', help='data type')
...
if __name__ == '__main__':
    ...
    TF2file = os.getcwd() + '/Dataset/Benchmark Datasets/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(args.num) + '/TF.csv'
    Gene2file = os.getcwd() + '/Dataset/Benchmark Datasets/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(args.num) + '/Target.csv'
    label_file = os.getcwd() + '/Dataset/Benchmark Datasets/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(args.num) + '/Label.csv'
